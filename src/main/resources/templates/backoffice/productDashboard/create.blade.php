...
<div class="content-wrapper">
  ...
  <section class="content">
    <form method="POST" action="{{route('createProductPersist')}}" id="myForm" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          @if($success ?? '')
          <!-- success allert -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Aggiungi prodotto" class="btn btn-success float-right">
        </div>
      </div>
    </form>
  </section>
