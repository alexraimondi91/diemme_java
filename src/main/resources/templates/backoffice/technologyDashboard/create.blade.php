...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Aggiungi tecnologia</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content">
    <form method="POST" action="{{route('createTechnologyPersist')}}" id="myForm" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          @if($success ?? '')
          <!-- success allert -->
              ...
              <div class="form-group @error('principalImage') has-error @enderror">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    ...
                    <input required type="file" onchange="check()" name="principalImage" class="custom-file-input" id="exampleInputFile">
                  </div>
                </div>
              </div>
              <div class="form-group @error('description') has-error @enderror">
                <label>Descrizione</label>
                <textarea class="form-control" required name="description" rows="3" placeholder="Descrizione...."></textarea>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
