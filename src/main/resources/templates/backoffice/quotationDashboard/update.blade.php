...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Aggiorna una istruzione di preventivo</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
            <li class="breadcrumb-item active">Aggiorna istruzione</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="content">
    <form method="POST" action="{{route('updateQuotationPersist')}}" id="myForm" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          @if($success ?? '')
          <!-- success allert -->
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group  @error('title') has-error @enderror">
                ...
                <input required name="title" type="text" value="{{$item->name}}" id="inputName" class="form-control">
              </div>
